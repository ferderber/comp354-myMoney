...
\begin{document}
	...
	\begin{itemize}
		...
		\item Added a functionality to delete Types from the type table if an edit cause a 				Type to no longer have an associated transactions.
	\end{itemize}
	
	\datesec{2018-03-14}{Test Cases}
	\begin{itemize}
		\item Edited existing test cases for Transactions to account for the Type field, and 			added test cases to specifically test the DAO for the Type table and a test for 				creating and manipulating Type objects.
	\end{itemize}
