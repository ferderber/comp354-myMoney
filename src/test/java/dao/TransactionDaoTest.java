...
public class TransactionDaoTest {
	...
	private static final Transaction testTransaction1 = new Transaction("sample transaction", "description", new Date(),
			55, null, null);
	private static final Transaction testTransaction2 = new Transaction(55, "name", "description", new Date(), 2, null,
			null);
	private static final Transaction testTransaction3 = new Transaction("test", "d", new Date(), 3, null, null);
	private static final Transaction testTransaction4 = new Transaction("test", "d", new Date(), 4, null, null);
	private static final Transaction testTransaction5 = new Transaction("test", "d", new Date(), 5, null, null);
