...
public class StatisticsController implements Initializable
{
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		List<String> name = stat.returnTypes();
		
		Types.getItems().addAll(name);
		
		Stats_Interface si = new Stats_Interface();
		
		main.Statistics.BarChart bco = si.displayYearStats();
	...
	public void updateStatistics(ActionEvent event) {
		...
		else if((!type.equals("")) && recc.equals(""))
		{
			...
			List<String> list = inter.displayStats(type, category);
		...
		{
			List<String> list = inter.displayRecurring(type, rec, category);
